...
.header01-banner>p>img{
    width: 100%;
    height:100%;
    border-radius: .04rem;
}
.header01-banner .header01-banner-right{
    width: 2.1rem;
    height: 1.5rem;
    margin-top: 1% ;
}
.header01-banner-right>p{
    font-size: .2rem;
    color: #fff;
    font-weight: 900;
